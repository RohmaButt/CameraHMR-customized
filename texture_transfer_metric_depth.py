...
# NEW: Enhanced visualization class with proper depth testing and occlusion handling
...
# Updated main estimator class with occlusion handling
class DynamicChestLogoHumanMeshEstimator(HumanMeshEstimator):
    ...
    def process_image_with_dynamic_chest_logo(self, img_path, logo_path, output_img_folder, i, 
                                        ...
                                        crop_bottom_percentage=0.5, crop_top_percentage=0.1):
        """Process image with dynamic chest logo positioning and proper occlusion handling"""
        ...
        for person_idx, mesh_data in enumerate(all_mesh_data):
            ...
            cv2.imwrite(os.path.join(output_folder, f"{person_base_name}_texture.png"), 
        ...
        print(f"Occlusion-aware rendering completed successfully!")
    ...
    def run_dynamic_chest_logo_pipeline(self, image_folder, logo_path, out_folder, logo_size=0.15, 
        ...
        """Run pipeline with dynamic chest logo positioning and occlusion handling"""
        ...
        print(f"=== OCCLUSION-AWARE DYNAMIC CHEST LOGO PIPELINE ===")
        ...
        print(f"\n{'='*60}")
        print("OCCLUSION-AWARE DYNAMIC CHEST LOGO PIPELINE COMPLETED!")
...
if __name__ == "__main__":
    ...
    def make_parser():
        parser = argparse.ArgumentParser(description='Occlusion-Aware Dynamic CameraHMR with Joint-based Chest Logo Positioning')
